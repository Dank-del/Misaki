...
from misaki.config import get_bool_key, get_list_key, get_int_key
from misaki.modules import ALL_MODULES, LOADED_MODULES
from misaki.services.quart import quart
...
if get_bool_key('LOAD_MODULES'):
    ...
    for module_name in modules:
        ...
        imported_module = import_module("misaki.modules." + module_name)
...
# Import misc stuff
import_module("misaki.utils.exit_gracefully")
if not get_bool_key('DEBUG_MODE'):
    import_module("misaki.utils.sentry")
...
import_module("misaki.utils.db_structure_migrator")
