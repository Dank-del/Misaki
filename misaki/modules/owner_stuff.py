...
from misaki import OWNER_ID, OPERATORS, SOPHIE_VERSION
from misaki.decorator import REGISTRED_COMMANDS, COMMANDS_ALIASES, register
from misaki.modules import LOADED_MODULES
from misaki.services.mongo import db, mongodb
...
async def stats(message):
    text = f"<b>Misaki {SOPHIE_VERSION} stats</b>\n"
